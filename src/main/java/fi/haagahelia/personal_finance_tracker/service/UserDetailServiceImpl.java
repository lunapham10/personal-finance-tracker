...
public class UserDetailServiceImpl implements UserDetailsService {
    ...
    private UserDetailServiceImpl(AppUserRepository uRepository) {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException{
        ...
        UserDetails user = new org.springframework.security.core.userdetails.User(username, curruser.getPasswordHarsh(),
